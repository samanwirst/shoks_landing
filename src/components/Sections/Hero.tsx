...
export function Hero({
    ...
    return (
        <div id="hero" className={cn(`relative min-h-screen w-full overflow-hidden bg-white`)}>
            ...
            <div className="relative z-10 min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <motion.p
                        variants={fadeInUp()}
                        className="text-lg sm:text-xl md:text-2xl font-medium text-gray-700 mb-8"
                    >
                    ...
                    >
                        ...
                        <motion.button
                            ...
                            className="px-8 py-4 rounded-sm text-base font-bold w-full sm:w-auto backdrop-blur-sm cursor-pointer bg-gray-100/80 hover:bg-gray-200/80 border border-gray-300 text-gray-700 hover:text-gray-900"
                            style={{
                                transition: 'all 0.3s cubic-bezier(0.25, 0.46, 0.45, 0.94)'
                            }}
                        >
