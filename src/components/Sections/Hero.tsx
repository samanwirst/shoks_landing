                ...
                >
                    ...
                    >
                        <motion.a
                            ...
                            whileTap={{ scale: 0.95 }}
                            className={`${baseSocialBtn} bg-gray-100/80 hover:bg-gray-200/80 border border-gray-300 text-gray-700 hover:text-blue-600 dark:bg-white/5 dark:hover:bg-white/10 dark:border-white/20 dark:text-white/80 dark:hover:text-blue-400`}
                        >
                        ...
                        <motion.a
                            ...
                            whileHover={{ scale: 1.0 }}
                            whileTap={{ scale: 0.95 }}
                            className={`${baseSocialBtn} bg-gray-100/80 hover:bg-gray-200/80 border border-gray-300 text-gray-700 hover:text-pink-600 dark:bg-white/5 dark:hover:bg-white/10 dark:border-white/20 dark:text-white/80 dark:hover:text-pink-400`}
                        >
                            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <motion.a
                            ...
                            whileHover={{ scale: 1.0 }}
                            whileTap={{ scale: 0.95 }}
                            className={`${baseSocialBtn} bg-gray-100/80 hover:bg-gray-200/80 border border-gray-300 text-gray-700 hover:text-blue-500 dark:bg-white/5 dark:hover:bg-white/10 dark:border-white/20 dark:text-white/80 dark:hover:text-blue-300`}
                        >
                            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
