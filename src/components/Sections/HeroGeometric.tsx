            ...
            <div className="relative z-10 min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="mb-8"
                    >
                        <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-6 md:mb-8 tracking-tight leading-tight cursor-default">
                    ...
                    <motion.div
                        ...
                        className="mb-8"
                    >
                        <p className={`text-lg sm:text-xl md:text-2xl font-medium cursor-default ${isWhiteTheme ? 'text-gray-700' : 'text-white/70'}`}>
                    ...
                    >
                        <motion.a
                            ...
                            whileHover="hover"
                            whileTap="tap"
                            className="bg-[#FF5F23] hover:bg-[#FF5F23]/90 text-white px-8 py-4 rounded-sm text-base font-bold shadow-[0_0_20px_rgba(255,95,35,0.5)] hover:shadow-[0_0_30px_rgba(255,95,35,0.7)] w-full sm:w-auto backdrop-blur-sm border border-[#FF5F23]/20 inline-block cursor-pointer"
                            style={{
                        ...
                        <motion.button 
                            ...
                            className={`px-8 py-4 rounded-sm text-base font-bold w-full sm:w-auto backdrop-blur-sm cursor-pointer ${isWhiteTheme 
